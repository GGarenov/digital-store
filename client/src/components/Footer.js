            ...
            <div className="col-4">
              ...
              <div>
                <address className="text-white">
                  Sofia bratle, <br /> Lozenets
                </address>
                <a href="tel:+359 878 525511" className="mt-4 d-block mb-3 text-white">
                  +359 878 525511
                </a>
                <a href="mailto:g_garenov@outlook.com" className="mt-0 d-block mb-3 text-white">
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear()}; Powered by Georgi Garenov
              </p>
            </div>
          </div>
        </div>
